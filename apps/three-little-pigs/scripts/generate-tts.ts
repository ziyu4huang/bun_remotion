/**
 * Generate TTS audio for all scenes in the Three Little Pigs cartoon story.
 *
...
async function main() {
  ...
  // Write durations.json so Root.tsx can read scene lengths
