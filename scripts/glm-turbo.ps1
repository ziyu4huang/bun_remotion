<#
.SYNOPSIS
    GLM AI Assistant Wrapper Script (PowerShell) — Turbo Model

.DESCRIPTION
    Provides a wrapper function 'glm' that interfaces with the GLM AI model
    through an Anthropic-compatible API endpoint, using glm-5-turbo.
...
.NOTES
    ...
    Override these env vars to customize behavior:
      Z_AI_MODEL_DEFAULT     - Default model (default: glm-5-turbo)
      Z_AI_MODEL_ALTERNATIVE - Alternative model (default: glm-5-turbo)
