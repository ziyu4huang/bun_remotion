...
for (const arg of args) {
  if (arg === "--server" || arg === "--mode=server") {
    ...
    console.log("Usage: bun_pi_agent [options]");
    console.log("");
    console.log("Options:");
    ...
    console.log("  PI_AGENT_MODEL   Provider/model (default: zai/glm-5-turbo)");
    ...
    console.log("  PI_AGENT_RUNS_DIR  Run persistence directory (default: <workdir>/.pi-agent/runs)");
    process.exit(0);
  }
}
