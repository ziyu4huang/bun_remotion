...
- Name: workflows-tree.spec.ts >> Workflows Page >> page renders with template selector
- Location: e2e/workflows-tree.spec.ts:12:3
...
Locator: getByRole('heading', { name: 'Workflows' })
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByRole('heading', { name: 'Workflows' })
