...
- Name: benchmark.spec.ts >> Benchmark >> run buttons are disabled when no project selected
- Location: e2e/benchmark.spec.ts:38:3
...
Locator: getByRole('button', { name: /Run Full Benchmark|Agent Benchmark/i })
Expected: disabled
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Run Full Benchmark|Agent Benchmark/i })
