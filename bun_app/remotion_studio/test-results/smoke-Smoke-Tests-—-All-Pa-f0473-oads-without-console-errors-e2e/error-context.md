...
- Name: smoke.spec.ts >> Smoke Tests — All Pages Load >> Dashboard page loads without console errors
...
- generic [ref=e3]:
  - navigation [ref=e4]:
    ...
    - button "Dashboard" [active] [ref=e6] [cursor=pointer]
  ...
  - main [ref=e19]:
    - generic [ref=e20]:
      ...
      - generic [ref=e25]:
        ...
        - button "Run Demo Job" [ref=e27] [cursor=pointer]
```
