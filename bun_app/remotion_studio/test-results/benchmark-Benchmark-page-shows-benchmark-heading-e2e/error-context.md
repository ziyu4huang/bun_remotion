...
- Name: benchmark.spec.ts >> Benchmark >> page shows benchmark heading
- Location: e2e/benchmark.spec.ts:12:3
...
Locator: getByRole('heading', { name: /Benchmark/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /Benchmark/i })
