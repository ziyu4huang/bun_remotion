...
- Name: toast-notifications.spec.ts >> Toast Notifications >> error toast auto-dismisses after timeout
- Location: e2e/toast-notifications.spec.ts:47:3
...
Call log:
  - waiting for locator('nav button').filter({ hasText: 'Dashboard' })
