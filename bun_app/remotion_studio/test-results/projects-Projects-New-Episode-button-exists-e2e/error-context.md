...
- Name: projects.spec.ts >> Projects >> + New Episode button exists
- Location: e2e/projects.spec.ts:28:3
...
Locator: getByRole('button', { name: '+ New Episode' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: '+ New Episode' })
