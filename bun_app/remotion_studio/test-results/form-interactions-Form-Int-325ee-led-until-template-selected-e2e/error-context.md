...
- Name: form-interactions.spec.ts >> Form Interactions >> Workflow trigger button disabled until template selected
- Location: e2e/form-interactions.spec.ts:22:3
...
Call log:
  - waiting for locator('nav button').filter({ hasText: 'Workflows' })
