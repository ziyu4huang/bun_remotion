...
- Name: form-interactions.spec.ts >> Form Interactions >> Create Episode form auto-fills chapter/episode
- Location: e2e/form-interactions.spec.ts:48:3
...
Call log:
  - waiting for locator('nav button').filter({ hasText: 'Projects' })
