# bun_scaffold — Episode Scaffold Generator
...
```bash
# From repo root
bun run scaffold --series galgame-meme-theater --ep 8
...
- `topics/episode-setup/scaffolding.md` — manual guide (bun_scaffold automates it)
