...
Use the [`getVideoDuration`](../utilities/get-video-duration.md) and [`getVideoDimensions`](../utilities/get-video-dimensions.md) skills to get the video duration and dimensions:
...
Use the [`getVideoDimensions`](../utilities/get-video-dimensions.md) skill to get the video dimensions:

```tsx
import { CalculateMetadataFunction } from "remotion";
import { getVideoDuration } from "../utilities/get-video-duration";
import { getVideoDimensions } from "../utilities/get-video-dimensions";
