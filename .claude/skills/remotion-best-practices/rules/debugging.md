...
- [./animations.md](./animations.md) — Spring and easing API gotchas
- [./dialog-driven.md](./dialog-driven.md) — Adaptive frame calculation pattern
- [./galgame.md](./galgame.md) — Common Mistakes table (full list)
