# storygraph — Federated Story Knowledge Graph

> **Cross-linked docs:**
>
> Skill folder (this) | Code folder
> ---|---
> `PLAN.md` — Architecture, node types, edge relations | `bun_app/storygraph/PLAN.md` — Code-level plan + reuse reference
...
├── storygraph_out/                # Series-level merged output
...
bun run --cwd bun_app/storygraph src/scripts/graphify-pipeline.ts <series-dir> --mode ai

# AI mode with specific provider/model
bun run --cwd bun_app/storygraph src/scripts/graphify-pipeline.ts <series-dir> --mode ai --provider anthropic --model claude-haiku-4-5-20251001

# Single episode in AI mode
bun run --cwd bun_app/storygraph src/scripts/graphify-episode.ts <ep-dir> --mode ai
```
