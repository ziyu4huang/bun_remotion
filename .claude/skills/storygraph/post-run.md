...
2. **Record to appropriate TODO:**
   - **Pipeline/architecture issues** → skill TODO (`.claude/skills/storygraph/TODO.md`) — add to Known Issues or P0/P1/P2
   - **Code implementation bugs** → code TODO (`bun_app/storygraph/TODO.md`) — add file/line references
