...
# Run after adding new emotions: bash bun_remotion_proj/my-core-is-boss/assets/scripts/sync-images.sh
set -eo pipefail
...
echo "Done. Asset images synced (episode-specific files preserved)."
