...
const dialogLines = [
  ...
  { character: "zhaoxiaoqi" as const, text: "「走過去」——師兄的意思是，這些妖獸根本不值一提，就像路邊的石頭一樣！", emotion: "think" as const, effect: "sparkle" as ComicEffect },
  ...
  { character: "zhaoxiaoqi" as const, text: "師兄又在謙虛了！「跳過」的真諦就是——超越！超越一切障礙！", emotion: "gloating" as const, effect: "sparkle" as ComicEffect },
