...
const dialogLines = [
  ...
  { character: "xiaoelder" as const, text: "空……空間禁錮？", emotion: "shock" as const },
  ...
  { character: "xiaoelder" as const, text: "那不是傳說中渡劫期以上才能施展的禁術嗎……？", emotion: "sweat" as const },
  ...
  { character: "linyi" as const, text: "什麼節點？我就是看哪裡有縫隙而已。", emotion: "default" as const },
