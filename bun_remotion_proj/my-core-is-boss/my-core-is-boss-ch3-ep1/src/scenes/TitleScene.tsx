  ...
  return (
    ...
    >
      <div style={{
        ...
        height: 800,
        borderRadius: "50%",
        background: `radial-gradient(circle, rgba(96, 165, 250, ${glowPulse}) 0%, transparent 70%)`,
        filter: "blur(40px)",
      }} />
      ...
      {frame >= 35 && frame <= 95 && (
        <SystemNotification
          text="新功能已解鎖：noclip 穿牆模式 — 消耗：0 — 冷卻：0"
          type="mission"
          delay={35}
        />
      )}
      ...
      <div style={{
        ...
        <div style={{
          ...
          fontWeight: 900,
          color: "#fff",
          textShadow: "0 0 40px rgba(96, 165, 250, 0.6), 0 4px 20px rgba(0,0,0,0.5)",
