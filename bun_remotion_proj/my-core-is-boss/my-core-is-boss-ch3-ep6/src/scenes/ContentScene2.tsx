...
// TODO: Fill in dialog lines for ContentScene2 (content scene 2)
// TODO: Choose background from assets/backgrounds/
const dialogLines = [
  { character: "narrator" as const, text: "TODO: 場景 2 的旁白或對話", emotion: "default" as const },
];
...
export const ContentScene2: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      {/* Scene indicator */}
      <SceneIndicator text="場景 2" color="#EF4444" />
