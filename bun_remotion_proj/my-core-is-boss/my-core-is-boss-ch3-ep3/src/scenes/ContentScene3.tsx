...
// TODO: Fill in dialog lines for ContentScene3 (content scene 3)
// TODO: Choose background from assets/backgrounds/
const dialogLines = [
  { character: "narrator" as const, text: "TODO: 場景 3 的旁白或對話", emotion: "default" as const },
];
...
export const ContentScene3: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      {/* Scene indicator */}
      <SceneIndicator text="場景 3" color="#EF4444" />
