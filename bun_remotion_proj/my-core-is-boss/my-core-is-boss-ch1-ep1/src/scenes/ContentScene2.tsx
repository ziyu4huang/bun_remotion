...
const dialogLines = [
  ...
  { character: "zhaoxiaoqi" as const, text: "「載入中」——師兄正在深度冥想，感悟天道運行之理。", emotion: "think" as const },
  { character: "zhaoxiaoqi" as const, text: "「跳過對話」——師兄認為言語道斷，大道不可言說。", emotion: "think" as const },
  { character: "zhaoxiaoqi" as const, text: "太深奧了……每一句話都蘊含著天地至理！", emotion: "cry" as const },
