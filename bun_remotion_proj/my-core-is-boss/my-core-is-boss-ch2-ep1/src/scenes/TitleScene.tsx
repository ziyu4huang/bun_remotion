  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        height: 800,
        borderRadius: "50%",
        background: `radial-gradient(circle, rgba(251, 191, 36, ${glowPulse}) 0%, transparent 70%)`,
        filter: "blur(40px)",
      }} />
      ...
      {/* System stinger notification — auto-cultivation unlock */}
      {frame >= 35 && frame <= 95 && (
        <SystemNotification
          text="新功能已解鎖：自動修煉腳本"
          type="info"
      ...
      <div style={{
        ...
        <div style={{
          width: lineWidth,
          height: 3,
          background: "linear-gradient(90deg, transparent, #FBBF24, #A78BFA, transparent)",
          margin: "20px auto 0",
          borderRadius: 2,
        }} />
      </div>
