...
export const WeaponForgerCh3Ep2: React.FC<Props> = ({ sceneDurations }) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a051e" }}>
      <TransitionSeries>
        {/* Title */}
        <TransitionSeries.Sequence durationInFrames={d(0)} name="Title">
          <TitleScene />
        ...
        {/* Content 1: 秘境深處 — 倒數計時 */}
        <TransitionSeries.Sequence durationInFrames={d(1)} name="Content 1: 秘境深處">
          <ContentScene1 />
        ...
        {/* Content 2: 智商測試開始 */}
        <TransitionSeries.Sequence durationInFrames={d(2)} name="Content 2: 智商測試">
          <ContentScene2 />
        ...
        {/* Outro */}
        <TransitionSeries.Sequence durationInFrames={d(3)} name="Outro">
          <OutroScene />
