    ...
    <AbsoluteFill>
      ...
      <div style={{
        ...
        <div style={{
          ...
          textShadow: "0 0 40px rgba(167, 139, 250, 0.5), 0 0 80px rgba(239, 68, 68, 0.3)",
      ...
      {frame >= 50 && (
        <MangaSfx events={[
          { text: "待續！", x: 1600, y: 900, color: "#A78BFA", rotation: -8, fontSize: 80, font: "brush", delay: 0 },
        ]} />
      )}
    </AbsoluteFill>
  );
