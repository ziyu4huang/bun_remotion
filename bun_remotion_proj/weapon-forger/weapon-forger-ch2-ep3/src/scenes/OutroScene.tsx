...
import { MangaSfx, notoSansTC, maShanZheng } from "@bun-remotion/shared";
    ...
    <AbsoluteFill>
      ...
      <div style={{
        ...
        <div style={{
          ...
          textShadow: "0 0 40px rgba(245, 158, 11, 0.5), 0 0 80px rgba(239, 68, 68, 0.3)",
        ...
        <div style={{
          ...
          <div style={{
            ...
            周墨掏出了「雷射切割陣法」——效率很高，但把整座秘境的禁制全切斷了，觸發了自毀倒數。
          </div>
        </div>
      </div>
      ...
      {frame >= 50 && (
        <MangaSfx events={[
          { text: "待續！", x: 1600, y: 900, color: "#EF4444", rotation: -8, fontSize: 80, font: "brush", delay: 0 },
        ]} />
      )}
    </AbsoluteFill>
  );
