...
/**
 * Title Scene — 誰讓他煉器的！ 第二章 第一集：禍害成軍
 * Consistent with ep1/ep2/ep3 title style.
 */
    ...
    <AbsoluteFill>
      ...
      <div style={{
        ...
        <div style={{
          ...
          textShadow: "0 0 40px rgba(245, 158, 11, 0.4), 0 0 80px rgba(52, 211, 153, 0.3), 0 4px 20px rgba(0,0,0,0.8)",
          letterSpacing: "0.1em",
          marginBottom: 30,
        }}>
          誰讓他煉器的！
        ...
        <div style={{
          ...
          textShadow: "0 0 30px rgba(245, 158, 11, 0.5), 0 2px 10px rgba(0,0,0,0.6)",
