...
const dialogLines: DialogLine[] = [
  ...
  { character: "narrator", text: "禁制。被切成了兩半。", sfx: [{ text: "唰────！", x: 960, y: 400, color: "#FF4444", rotation: -45, fontSize: 120, font: "action" }] },
  ...
  { character: "narrator", text: "整座秘境震動。牆壁上浮現出上古文字：「警告——禁制系統已離線——保護機制啟動——自毀倒數：一百八十息。」", effect: "shake", sfx: [{ text: "警告！", x: 960, y: 250, color: "#EF4444", rotation: 0, fontSize: 120, font: "action" }] },
