...
import { ScreenShake, ScreenFlash, SlashEffect, ConcentrationLines, ImpactBurst, TriangleBurst } from "../components/BattleEffects";
...
import type { DialogLine, ComicEffect, MangaSfxEvent } from "../characters";
