 ...
 * Improvements over ep1:
 *   - Larger breathing amplitude
 *   - More aggressive shake/bounce on emotions
 *   - Pulsing glow that's more visible
 *   - Entrance with spring overshoot
 *   - Emotion-specific color overlays
 *   - Floating animation for emphasis moments
 */
...
export const CharacterSprite: React.FC<CharacterSpriteProps> = ({
  ...
  // Entrance animation with more dramatic overshoot
  ...
  // ─── Speaking: breathing (MORE OBVIOUS) ─────────────────────────────
  ...
  if (speaking && hasShake) {
    ...
    // Slow floating for smug/gloating
  ...
  return (
    ...
    >
      {/* Glow behind character (ENHANCED — larger, brighter) */}
      {speaking && (
        <div
          style={{
            position: "absolute",
