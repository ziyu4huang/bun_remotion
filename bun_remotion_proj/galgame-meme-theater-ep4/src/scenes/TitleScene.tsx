...
/**
 * EP4 Opening — 6-phase cinematic title sequence.
...
export const TitleScene: React.FC = () => {
  ...
  // ─── Phase 1: EP4 badge with spring pop ─────────────────────────────────
  ...
  const stars = Array.from({ length: 20 }).map((_, i) => {
    ...
    // Continuous sine-wave opacity — no fade-out
  ...
  const topics = [
    { label: "梗一：期末考前一週", color: "#F472B6", accent: "#FBBF24" },
    { label: "梗二：手搖飲中毒", color: "#818CF8", accent: "#38BDF8" },
    { label: "梗三：捷運社交距離大師", color: "#06D6A0", accent: "#34D399" },
    { label: "梗四：實習生的真實生活", color: "#FB923C", accent: "#FCD34D" },
  ];
  ...
  return (
    <AbsoluteFill style={{ opacity: fadeOut }}>
      ...
      {topics.map((topic, i) => {
        ...
        // Slide in (0-12), hold (12-42), slide out (42-55)
      ...
      {characterShowcase.map((char, i) => {
        ...
        // Fade in (0-10), hold (10-37), fade out (37-47)
