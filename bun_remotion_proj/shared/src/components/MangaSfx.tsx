...
import { sfxFont } from "../fonts";
import type { MangaSfxEvent } from "../types";
      ...
      <div
        style={{
          ...
          background: `conic-gradient(
            ...
            transparent 20deg, rgba(255, 255, 255, 0.9) 25deg, transparent 30deg,
            transparent 40deg, rgba(255, 255, 255, 0.9) 45deg, transparent 50deg,
            transparent 60deg, rgba(255, 255, 255, 0.9) 65deg, transparent 70deg,
            transparent 80deg, rgba(255, 255, 255, 0.9) 85deg, transparent 90deg,
            transparent 100deg, rgba(255, 255, 255, 0.9) 105deg, transparent 110deg,
            transparent 120deg, rgba(255, 255, 255, 0.9) 125deg, transparent 130deg,
            transparent 140deg, rgba(255, 255, 255, 0.9) 145deg, transparent 150deg,
            transparent 160deg, rgba(255, 255, 255, 0.9) 165deg, transparent 170deg,
            transparent 180deg, rgba(255, 255, 255, 0.9) 185deg, transparent 190deg,
            transparent 200deg, rgba(255, 255, 255, 0.9) 205deg, transparent 210deg,
            transparent 220deg, rgba(255, 255, 255, 0.9) 225deg, transparent 230deg,
            transparent 240deg, rgba(255, 255, 255, 0.9) 245deg, transparent 250deg,
            transparent 260deg, rgba(255, 255, 255, 0.9) 265deg, transparent 270deg,
            transparent 280deg, rgba(255, 255, 255, 0.9) 285deg, transparent 290deg,
            transparent 300deg, rgba(255, 255, 255, 0.9) 305deg, transparent 310deg,
            transparent 320deg, rgba(255, 255, 255, 0.9) 325deg, transparent 330deg,
            transparent 340deg, rgba(255, 255, 255, 0.9) 345deg, transparent 350deg,
            transparent 360deg
          )`,
        }}
      />
