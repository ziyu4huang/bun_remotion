...
export const GalgameMemeTheater: React.FC<Props> = ({ sceneDurations }) => {
  ...
  const scenes = [
    ...
    { Scene: JokeScene1, audio: "audio/02-joke1.wav" },
    { Scene: JokeScene2, audio: "audio/03-joke2.wav" },
    { Scene: JokeScene3, audio: "audio/04-joke3.wav" },
    { Scene: JokeScene4, audio: "audio/05-joke4.wav" },
    { Scene: OutroScene, audio: "audio/06-outro.wav" },
  ];
