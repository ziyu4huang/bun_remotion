  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a051e" }}>
      <TransitionSeries>
        ...
        {/* Joke1 → Joke2: flip (fun transition for topic change) */}
        <TransitionSeries.Transition
        ...
        {/* Joke2 → Joke3: wipe from right (scene change) */}
        <TransitionSeries.Transition
        ...
        {/* Joke3 → Joke4: clockWipe (fun/unique) */}
        <TransitionSeries.Transition
