...
export const OutroScene: React.FC = () => {
  ...
  // Subtitle items
  const subtitles = [
    { text: "暗戀不如明戀", delay: 60 },
    { text: "直男的心思不要猜", delay: 72 },
    { text: "已讀不回就當他死了", delay: 84 },
    { text: "催婚的時候裝聽不懂就好", delay: 96 },
  ];

  return (
    <AbsoluteFill style={{ opacity: fadeIn }}>
      <BackgroundLayer
        gradient="linear-gradient(135deg, #1a0a2e 0%, #2a0a1e 40%, #1a1a3e 70%, #0a0a2e 100%)"
      />
      ...
      >
        <div
          style={{
            ...
            fontWeight: 700,
            color: "#F3E8FF",
            textShadow: "0 0 30px rgba(244, 114, 182, 0.4), 0 0 60px rgba(255, 107, 157, 0.2)",
            letterSpacing: "0.1em",
            marginBottom: 20,
          }}
        >
