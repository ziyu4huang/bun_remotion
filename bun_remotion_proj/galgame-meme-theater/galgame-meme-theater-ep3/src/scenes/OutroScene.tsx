...
export const OutroScene: React.FC = () => {
  ...
  // Character color bars — each slides in
  const charBars = [
  ...
  // Subtitle items fade in one by one
  const subtitles = [
    { text: "過年是生存遊戲", delay: 60 },
    { text: "夜市沒有所謂的吃太飽", delay: 72 },
    { text: "永遠不要相信氣象局", delay: 84 },
    { text: "已讀不回是基本社交技能", delay: 96 },
  ];
      ...
      >
        <div
          style={{
            ...
            fontWeight: 700,
            color: "#F3E8FF",
            textShadow: "0 0 30px rgba(255, 215, 0, 0.4), 0 0 60px rgba(244, 114, 182, 0.2)",
            letterSpacing: "0.1em",
            marginBottom: 20,
          }}
        >
        ...
        <div
          style={{
            width: lineWidth,
            height: 2,
            background: "linear-gradient(90deg, transparent, #FFD700, #F472B6, #818CF8, transparent)",
            marginBottom: 24,
          }}
        />
