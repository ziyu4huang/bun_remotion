...
/**
 * Transition duration in frames (0.5s at 30fps).
 * Used for calculating total composition duration and as timing parameter.
 */
export const TRANSITION_FRAMES = 15;

export const GalgameMemeTheaterEp3: React.FC<Props> = ({ sceneDurations }) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0a051e" }}>
      <TransitionSeries>
        ...
        {/* Transition: Title → Joke1 (fade — gentle intro) */}
        ...
        {/* Transition: Joke1 → Joke2 (slide from right — energetic) */}
        <TransitionSeries.Transition
        ...
        {/* Transition: Joke2 → Joke3 (wipe from right — dramatic) */}
        <TransitionSeries.Transition
        ...
        {/* Transition: Joke3 → Joke4 (clock wipe — fun/unique) */}
        <TransitionSeries.Transition
        ...
        {/* Transition: Joke4 → Outro (fade — gentle outro) */}
        <TransitionSeries.Transition
          presentation={fade()}
          timing={linearTiming({ durationInFrames: TRANSITION_FRAMES })}
        />
